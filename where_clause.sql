...
select * from books where title like '%SqL%'; -- word search sql
select * from books where title like 'the%'; -- starting word search
select * from books where title like binary '%SQL%'; -- case insensitive word search
select * from books where author like '_ohn%'; -- word search after one letter
...
select * from books where category in (
select category from books where in_stock > 75
);

select * from books where in_stock > 75
