...
SELECT a.author_id, a.first_name, a.first_name, b.title
FROM authors as A
JOIN books as b
ON a.author_id = b.author_id order by a.birth_year
...
insert into book_categories (book_id, categories_id)
values
    ...
    join categories c on c.categories_id = bc. categories_id
    group by b.book_id;
