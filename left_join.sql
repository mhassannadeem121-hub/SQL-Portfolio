...
select c.customer_id, c.customer_name, o.order_date, o.order_id, o.total_amount
from customers c 
left join orders o 
...
select c.customer_id , c.customer_name, o.order_id, o.order_date, s.carrier, s.tracking_number 
from customers c 
